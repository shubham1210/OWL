...
public class HermitTest {
 ...
 public static void main(String[] args) throws Exception {
     ...
     File inputOntologyFile = new File("C:/Users/User/workspace/OwlTest1/src/main/java/v1.owl");
     ...
     File inferredOntologyFile=new File("http://protege.stanford.edu/ontologies/pizza/pizza1.owl");
